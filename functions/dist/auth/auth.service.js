...
var AuthService = (function () {
    ...
    AuthService.prototype.validateUser = function (correo, pass) {
        return __awaiter(this, void 0, void 0, function () {
            var user, _a, password, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, this.userService.findByCorreo(correo)];
                    case 1:
                        user = _b.sent();
                        _a = user;
                        if (!_a) return [3, 3];
    ...
    AuthService.prototype.login = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                payload = { correo: user.correo, sub: user.id, rol: user.rol };
                return [2, {
