...
var create_cliente_input_1 = require("./dto/create-cliente.input");
...
var ClienteResolver = (function () {
    function ClienteResolver(clienteService) {
        this.clienteService = clienteService;
    }
    ClienteResolver.prototype.createCliente = function (input) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                console.log('[BACKEND] Cliente recibido:', input);
                return [2, this.clienteService.create(input)];
            });
        });
    };
    ClienteResolver.prototype.findAllClientes = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.clienteService.findAll()];
            });
        });
    };
    ...
    __decorate([
        (0, graphql_1.Mutation)(function () { return cliente_entity_1.Cliente; }),
    ...
    __decorate([
        (0, graphql_1.Query)(function () { return [cliente_entity_1.Cliente]; }),
        (0, roles_decorator_1.Roles)(user_entity_1.UserRole.PARROCO),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], ClienteResolver.prototype, "findAllClientes", null);
    __decorate([
