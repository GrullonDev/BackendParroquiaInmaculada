...
var UserService = (function () {
    ...
    UserService.prototype.create = function (input) {
    ...
    UserService.prototype.findByCorreo = function (correo) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.userRepository.findOne({ where: { correo: correo } })];
                    case 1:
                        user = _a.sent();
                        return [2, user !== null && user !== void 0 ? user : undefined];
                }
            });
        });
    };
    UserService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.userRepository.find()];
            });
        });
    };
